...
class HTTPClient(httplib2.Http):
    ...
    def __init__(self, username='admin', tenant_id=None, tenant_name='admin',
                 password='ADMIN', auth_url=None, region_name=None, timeout=None,
...
#    username=None, tenant_id=None, tenant_name=None,
#                 password=None, auth_url=None, region_name=None, timeout=None,
#                 endpoint=None, token=None, cacert=None, key=None,
#                 cert=None, insecure=False
    aus = HTTPClient(auth_url='http://192.168.1.105:5000/v2.0/',username='zhoujip',password='zhoujip',tenant_name='admin')
